...
class FileConfig(Config):
    def __init__(self, project_name, output_model_name):
        ...
        self.curated_data = os.path.join(
            self.data_dir, self.experiment_name, "interim", "ml", "curation", "esg_TEXT_dataset.csv"
        )
        ...
        self.saved_models_dir = os.path.join(
            self.root, "models", self.experiment_name, self.experiment_type, self.data_type, self.output_model_name
        )
...
class ModelConfig(Config):
    def __init__(self, project_name):
        ...
        self.load_dir = os.path.join(
            self.root, "models", "base", "relevance_roberta"
...
class InferConfig(Config):
    def __init__(self, project_name, output_model_name):
        ...
        self.result_dir = {
            "Text": os.path.join(
                self.root, "data", self.experiment_name, "output", self.experiment_type, self.data_type
            )
        }
        self.kpi_questions = []
