...
def test_prepare_kpispecs():
    ...
    def prepare_kpi_2_0_provable_plus_probable_reserves():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("proven develop or undevelop reserv"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("proven reserves"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("total hydrocarbon"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                letter_decay_hl=10,
                letter_decay_disregard=len("total"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("total proven reserves"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("total reserves"),
            )
        )
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=10,
                letter_decay_disregard=len("2p reserves"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=10,
                letter_decay_disregard=len("proved and proable"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
        ...
        kpi.unit_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw=".*(boe|barrel.*oil|(b|m)illion.*barrel).*", case_sensitive=False)
        )
        kpi.value_must_be_numeric = True

        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*exploration.*", case_sensitive=False),
                ...
                letter_decay_hl=5,
                letter_decay_disregard=len("exploration"),
            )
        )
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*upstream.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=2000,
                matching_mode=MATCHING_MAY_INCLUDE,
                score_decay=0.9,
                multi_match_decay=0.5,
                letter_decay_hl=5,
                letter_decay_disregard=len("upstream"),
            )
        )
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw="^balance sheet.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=2000,
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(
                    pattern_raw=".*((^|[^a-z])prov|(^|[^a-z])2p($|[^a-z])).*", case_sensitive=False
                ),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=500,
                ...
                letter_decay_hl=8,
                letter_decay_disregard=len("prov"),
            )
        )
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(
                    pattern_raw=".*((^|[^a-z])prob|(^|[^a-z])2p($|[^a-z])).*", case_sensitive=False
                ),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=500,
                matching_mode=MATCHING_MUST_INCLUDE,
                ...
                multi_match_decay=0.2,
                letter_decay_hl=8,
                letter_decay_disregard=len("prob"),
            )
        )
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                multi_match_decay=0.2,
                letter_decay_hl=10,
                letter_decay_disregard=len("prov prob"),
            )
        )
    ...
    def prepare_kpi_2_1_provable_reserves():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                pattern_raw=".*(^|[^a-z])prov.*develop.*undevelop.*reserv.*",
                score=12000,
                matching_mode=MATCHING_CAN_INCLUDE,
                score_decay=0.8,
                case_sensitive=False,
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                pattern_raw=".*(^|[^a-z])prov.*reserv.*oil.*",
                score=12000,
                matching_mode=MATCHING_MAY_INCLUDE,
                score_decay=0.8,
                case_sensitive=False,
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                pattern_raw=".*(^|[^a-z])prov.*reserv.*(oil.*gas|gas.*oil).*",
                score=15000,
                matching_mode=MATCHING_MAY_INCLUDE,
                score_decay=0.8,
                case_sensitive=False,
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=10,
                letter_decay_disregard=len("1p reserves"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                pattern_raw=".*(^|[^a-z])prov.*",
                score=3000,
                matching_mode=MATCHING_MAY_INCLUDE,
                score_decay=0.8,
                case_sensitive=False,
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("proven reserves sec"),
            )
        )
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(
                    pattern_raw=".*((^|[^a-z])prov|(^|[^a-z])1p($|[^a-z])).*", case_sensitive=False
                ),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=500,
                matching_mode=MATCHING_MUST_INCLUDE,
    ...
    def prepare_kpi_3_production():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("total production"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("hydrocarbon production"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("oil production"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("interest production"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("group production"),
            )
        )
        ...
        kpi.unit_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(
                pattern_raw=".*(boe|barrel.*oil|(b|m)illion.*barrel|tonnes).*", case_sensitive=False
            )
        )
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*production.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=100,
                matching_mode=MATCHING_MAY_INCLUDE,
                score_decay=0.9,
                multi_match_decay=0.5,
                letter_decay_hl=5,
                letter_decay_disregard=len("production"),
            )
        )
    ...
    def prepare_kpi_3_2_liquid_hydrocarbons_production():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("liquid hydrocarbon"),
            )
        )
        ...
        kpi.unit_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(
                pattern_raw=".*(boe|barrel.*oil|(b|m)illion.*barrel|ton|mt).*", case_sensitive=False
            )
        )
    ...
    def prepare_kpi_3_3_gas_production():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("production gas"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=1,
                letter_decay_hl=20,
                letter_decay_disregard=len("gas"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("gas production"),
            )
        )
        ...
        kpi.unit_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(
                pattern_raw=".*(boe|barrel.*oil|(b|m)illion.*barrel|ton|mt|million|cm).*", case_sensitive=False
            )
        )
    ...
    def prepare_Scope1_kpi_6_Direct_total_GHG_emissions():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=15,
                letter_decay_disregard=len("gas direct"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=30,
                letter_decay_disregard=len("direct scope 1"),
            )
        )
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                multi_match_decay=0.2,
                letter_decay_hl=8,
                letter_decay_disregard=len("direct"),
            )
        )
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                multi_match_decay=0.2,
                letter_decay_hl=8,
                letter_decay_disregard=len("c6.1"),
            )
        )
        kpi.value_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw=".*[0-9].*[0-9].*", case_sensitive=False)
    ...
    def prepare_kpi_7_Scope2_GHGs_emissions():
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(
                    pattern_raw=".*(environment|emission).*", case_sensitive=False
                ),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=100,
                matching_mode=MATCHING_MAY_INCLUDE,
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                letter_decay_hl=5,
                letter_decay_disregard=len("tons co2"),
            )
        )  # by Lei
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                multi_match_decay=0.01,
                letter_decay_hl=5,
                letter_decay_disregard=len("million metric"),
            )
        )  # by Lei
    ...
    def prepare_kpi_8_Scope3_GHGs_emissions():
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                ...
                multi_match_decay=0.5,
                letter_decay_hl=5,
                letter_decay_disregard=len("environment"),
            )
        )
    ...
    def prepare_kpi_12_Target_Year_Reduction():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("targeted reduction from base year"),
            )
        )
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*target year.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=5000,
                matching_mode=MATCHING_MUST_INCLUDE,
                score_decay=0.9,
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*scope 1.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=5000,
                matching_mode=MATCHING_CAN_INCLUDE,
                score_decay=0.9,
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(pattern_raw=".*c4\.1a.*", case_sensitive=False),
                distance_mode=DISTANCE_MOD_EUCLID,
                score=5000,
                matching_mode=MATCHING_CAN_INCLUDE,
                score_decay=0.9,
        ...
        kpi.value_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw="[0-9]{2,3}(\.[0-9]+)?", case_sensitive=False)
        )  # must be 2-3 digits, optional fractional part
    ...
    def prepare_kpi_9991_CDP_0_4_Currency():
        ...
        kpi.value_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw="[A-Z]{3,3}", case_sensitive=True)
    ...
    def prepare_kpi_9992_CDP_4_1_Emiss_Target():
        ...
        kpi.value_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw="[A-Z ]{3,35}target[A-Z ]{0,10}", case_sensitive=False)
        )  # must be 3 uppercase letters
    ...
    def prepare_kpi_9993_CDP_4_2b_Year_Target_Set():
        ...
        kpi.desc_regex_match_list.append(
            KPISpecs.DescRegExMatch(
                ...
                multi_match_decay=0,
                letter_decay_hl=20,
                letter_decay_disregard=len("Year target was set"),
            )
        )
        ...
        kpi.anywhere_regex_match_list.append(
            KPISpecs.AnywhereRegExMatch(
                general_match=KPISpecs.GeneralRegExMatch(
                    pattern_raw=".*\(c4\.2b\) *provide details of .*targets.*", case_sensitive=False
                ),
        ...
        kpi.value_regex_match_list.append(
            KPISpecs.GeneralRegExMatch(pattern_raw="(19[8-9]|20[0-2])[0-9]", case_sensitive=False)
        )  # must be year 1980-2029
