            ...
            for pdf_file_name in pdf_file_names:
                ...
                for s in test_data.samples:
                    if s.data_kpi_id == kpispec.kpi_id and s.fixed_source_file == pdf_file_name:
                        ...
                        if cur_eval_sample is None:
                            # no
                            cur_eval_sample = TestEvaluation.TestEvalSample(
                                kpispec, None, s, s.data_year, pdf_file_name
                            )
                ...
                for k in kpiresults.kpimeasures:
                    ...
                    for e in res.eval_samples:
                        if (
                            e.kpimeasure is not None
                            and k.kpi_id == e.kpispec.kpi_id
                            and k.year == e.year
                            and e.kpimeasure.src_file == pdf_file_name
                        ):
                            found = True
                            break
                    if not found:
