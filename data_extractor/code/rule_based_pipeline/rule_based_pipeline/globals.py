...
def hsv_to_rgba(h, s, v):  # h,s,v in [0,1], result r,g,b,a in [0,256)
    ...
    i %= 6
    if i == 0:
        return (int(255 * v), int(255 * t), int(255 * p), 255)
    if i == 1:
        return (int(255 * q), int(255 * v), int(255 * p), 255)
    if i == 2:
        return (int(255 * p), int(255 * v), int(255 * t), 255)
    if i == 3:
        return (int(255 * p), int(255 * q), int(255 * v), 255)
    if i == 4:
        return (int(255 * t), int(255 * p), int(255 * v), 255)
    if i == 5:
        return (int(255 * v), int(255 * p), int(255 * q), 255)
