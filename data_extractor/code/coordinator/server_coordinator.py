...
def train():
    ...
    parser_train.add_argument("--project_name", type=str, default=None, help="Name of the Project")

    parser_train.add_argument("--s3_usage", type=str, default=None, help="Do you want to use S3? Type either Y or N.")
    ...
    cmd = "python3 train_on_pdf.py" + ' --project_name "' + project_name + '"' + ' --s3_usage "' + s3_usage + '"'
...
def infer():
    ...
    parser_infer.add_argument("--project_name", type=str, default=None, help="Name of the Project")

    parser_infer.add_argument("--s3_usage", type=str, default=None, help="Do you want to use S3? Type either Y or N.")
